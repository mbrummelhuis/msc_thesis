...
sudo apt-get update
## Get ROS/Gazebo // Changed version to noetic
...
## Install rosinstall and other dependencies // updated commands to python3
sudo apt install python3-rosdep python3-rosinstall python3-rosinstall-generator python3-wstool build-essential -y



# MAVROS: https://dev.px4.io/en/ros/mavros_installation.html
## Install dependencies // updated commands to python3
...
## Install MAVLink
###we use the Kinetic reference for all ROS distros as it's not distro-specific and up to date // Changed version to noetic
